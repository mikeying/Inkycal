...
| `show_location` | `true` / `false` | Show resolved location name at top of today's section (auto-sized to fit header space; remaining weather text uses configured `fontsize`) |
